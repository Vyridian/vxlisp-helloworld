...
import mydomain_app from "../../src/mydomain/app.js"
import vx_core from "../../src/vx/core.js"
import vx_test from "../../src/vx/test.js"
import vx_web_html from "../../src/vx/web/html.js"
import vx_web_htmldoc from "../../src/vx/web/htmldoc.js"

export default class mydomain_app_test {


  static test_package(context) {
    const testcaselist = mydomain_app_test.test_cases(context)
    const output = vx_core.f_new(
      vx_test.t_testpackage,
      ":testpkg", "mydomain/app",
      ":caselist", testcaselist,
      ":coveragesummary", mydomain_app_test.test_coveragesummary(),
      ":coveragedetail", mydomain_app_test.test_coveragedetail()
    );
    return output;
  }
        ...
        vx_core.f_new(
          ...
          vx_core.f_new(
            ...
            vx_test.f_test(
              context,
              "<p>a</p>",
              mydomain_app.f_string_html_from_text("a")
            )
          )
        )
    )
  ...
  static test_cases(context) {
    const output = vx_core.f_new(
      ...
      mydomain_app_test.f_myfunc(context),
      mydomain_app_test.f_p_from_text(context),
      mydomain_app_test.f_string_html_from_text(context)
    )
    return output
  }
}
