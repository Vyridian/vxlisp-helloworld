...
#include <iostream>
#include "vx/core.hpp"
#include "mydomain/mypackage.hpp"
...
int main(int iarglen, char* arrayarg[]) {
  ...
  try {
    ...
    std::string soutput = "";
    context = mydomain_mypackage::f_context_main(arglist);
    vx_core::vx_reserve_context(context);
    vx_core::Type_string mainstring = mydomain_mypackage::f_main_exe(context, arglist);
