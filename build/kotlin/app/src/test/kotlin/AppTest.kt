...
object AppTest {
  ...
  fun test_mydomain_mypackage() : Unit {
    val testpackage : vx_test.Type_testpackage = mydomain_mypackageTest.test_package(context)
    TestLib.run_testpackage_async(testpackage)
  }
  ...
  fun test_writetestsuite() {
    val testpackagelist : vx_test.Type_testpackagelist = vx_core.vx_new(
      ...
      mydomain_mypackageTest.test_package(context),
